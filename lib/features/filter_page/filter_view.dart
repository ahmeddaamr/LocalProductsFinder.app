                            ...
                            buildButton(label: "Apply" ,
                             onPress: () {
                              ...
                              // FilterData.selectedRatings
                                ...
                                setState(() {
                                FilterData.selectedCategories = List.from(FilterData.tempSelectedCategories);
                                FilterData.selectedSubCategories = List.from(FilterData.tempSelectedSubCategories);
                                FilterData.selectedRatings = List.from(FilterData.tempSelectedRatings);
                                });
